...
actions = ['crunch', 'other']

seq_length = 15
model = load_model(
    'C:/Users/UCL7/VS_kwix/created_dataset/dataset_version9/crunch/model_v9_1.h5')
pose = set_cam()
N_scaler = Normalizer()

seq, action_seq = [], []
cap = cv2.VideoCapture(
    'C:/Users/UCL7/VS_kwix/Byungsun_main/create_model/crunch2.mp4')
...
while True:
    ...
    if results.pose_landmarks is not None:
        ...
        if action_seq[-1] == action_seq[-2]:
            if y_pred[0] > 0.8:
                rate = 0
                img = draw_function.drawing_Crunch(
