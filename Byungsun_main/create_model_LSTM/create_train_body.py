...
os.makedirs('C:/Users/UCL7/VS_kwix/train_dataset_v4/', exist_ok=True)

for i, _ in enumerate(actions):
    os.makedirs('C:/Users/UCL7/VS_kwix/train_dataset_v4/' + _actions[i], exist_ok=True)
    ...
    for idx, action in enumerate(_):
        ...
        np.save(os.path.join('C:/Users/UCL7/VS_kwix/train_dataset_v4/' + _actions[i],
