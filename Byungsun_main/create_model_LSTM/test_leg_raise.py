...
actions = ['leg_raise', 'other']

seq_length = 15
model = load_model(
    'C:/Users/UCL7/VS_kwix/created_dataset/dataset_version9/lying_leg_raise/model_v9_3.h5')
pose = set_cam()
N_scaler = Normalizer()
...
cap = cv2.VideoCapture(
    'C:/Users/UCL7/VS_kwix/Byungsun_main/create_model/leg_raise1.mp4')
...
while True:
    ...
    if results.pose_landmarks is not None:
        ...
        if action_seq[-1] == action_seq[-2]:
            if y_pred[0] > 0.8:
                rate = 0
                img = draw_function.drawing_Leg_raise(
