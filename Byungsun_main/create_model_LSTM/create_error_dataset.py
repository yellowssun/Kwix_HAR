...
os.makedirs('C:/Users/UCL7/Desktop/Kwix_HAR/error_dataset_v1/', exist_ok=True)

for i, _ in enumerate(_actions):
    os.makedirs('C:/Users/UCL7/Desktop/Kwix_HAR/error_dataset_v1/' + _actions[i], exist_ok=True)
    ...
    data = np.array(data)
    print(_, data.shape)
    np.save(os.path.join('C:/Users/UCL7/Desktop/Kwix_HAR/error_dataset_v1/' + _actions[i],
