...
def CNN_109():
    ...
    model.build(input_shape=(None, 15, 109))
    return model


def LS_109():
    model = Sequential()
    model.add(LSTM(64, return_sequences=True, input_shape=(15, 109), dropout=0.3))
...
def BiLS_109():
    model = Sequential()
    model.add(Bidirectional(LSTM(64, return_sequences=True, input_shape=(15, 109), dropout=0.3)))
