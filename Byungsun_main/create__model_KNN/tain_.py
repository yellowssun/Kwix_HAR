...
from operation import load_data_2, seperate_label, plot_confusion_matrix, seperate_angle
...
for index, name in enumerate(model_name):
    ...
    for idx, _ in enumerate(_actions):
        ...
        path_dir1 = 'C:/Users/UCL7/Desktop/Kwix_HAR/train_dataset_v8/' + _actions[idx]
        folder_list1 = os.listdir(path_dir1)
        data = load_data_2(path_dir1, folder_list1)
